    ...
    <div className="flex font-grotesque min-h-screen leading-[1.2] font-semibold" style={{ backgroundColor: currentColors.background, color: currentColors.text }}>
      ...
      <div className="flex-1 flex flex-col w-full">
        ...
        >
          ...
          <h1 className="text-xl sm:text-2xl font-bold" style={{ color: isDarkMode ? "white" : currentColors.text }}>Your Profile</h1>
        </div>
        ...
        <div className="flex-1 p-3 sm:p-4 lg:p-6 xl:p-10 overflow-y-auto">
          ...
          <h1 className="text-4xl font-bold text-center mb-2" style={{ color: currentColors.text }}>
            Your Profile
          </h1>
          <p className="text-gray-300 mb-8 text-center" style={{ color: currentColors.textSecondary }}>
            ...
            <div className="flex flex-col xl:flex-row gap-3 sm:gap-4 xl:gap-6">
              ...
              <div className="rounded-2xl p-3 sm:p-4 lg:p-6 w-full xl:w-72 2xl:w-80 mx-auto xl:mx-0 text-center shadow-lg border h-fit" style={{
                ...
                <h2 className="text-xl font-bold mt-3 lg:mt-4" style={{ color: currentColors.text }}>
                  {profileName}
                </h2>
              ...
              <div className="rounded-2xl flex-1 p-3 sm:p-4 lg:p-6 border shadow-lg" style={{
                ...
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-bold" style={{ color: currentColors.text }}>Personal Details</h3>
