          ...
          <div className="flex-1 min-w-0 w-full px-2 sm:px-4 md:px-8 lg:px-12 py-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-1">
                  ...
                  <div className="mt-4 flex flex-col sm:flex-row gap-2">
                    <Button className="text-sm py-1.5 px-4 w-full sm:w-auto">
                      Create Space
                    </Button>
                    <Button className="text-sm py-1.5 px-4 w-full sm:w-auto">
                      Join Space
            ...
            <div className="mb-8">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <button
                    onClick={() =>
                      setSlideIndexYourSpace(
                        Math.min(
                          Math.ceil(yourSpaceData.length / 3) - 1,
                          slideIndexYourSpace + 1,
                        ),
                      )
                    }
                    className="text-gray-400 hover:text-white text-lg px-2 py-1 rounded bg-transparent disabled:opacity-30"
                  ...
                  <button className="hidden sm:inline text-[#007AFF] hover:underline text-sm ml-2 bg-transparent">
                    View All
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                {yourSpaceData
                  .slice(slideIndexYourSpace * 3, (slideIndexYourSpace + 1) * 3)
                  .map((space, i) => (
                    <div
                      key={i}
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex gap-2 items-center">
                  <button
                    onClick={() =>
                      setSlideIndexSchoolSpace(
                        Math.max(0, slideIndexSchoolSpace - 1),
                      )
                    }
                    className="text-gray-400 hover:text-white text-lg px-2 py-1 rounded bg-transparent disabled:opacity-30"
                  ...
                  <button
                    onClick={() =>
                      setSlideIndexSchoolSpace(
                        Math.min(
                          Math.ceil(schoolSpaceData.length / 3) - 1,
                          slideIndexSchoolSpace + 1,
                        ),
                      )
                    }
                    className="text-gray-400 hover:text-white text-lg px-2 py-1 rounded bg-transparent disabled:opacity-30"
                    disabled={
                      slideIndexSchoolSpace >=
                      Math.ceil(schoolSpaceData.length / 3) - 1
                    }
                  >
                    ›
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                {schoolSpaceData
                  .slice(
                    slideIndexSchoolSpace * 3,
                    (slideIndexSchoolSpace + 1) * 3,
                  )
                  .map((space, i) => (
                    <div
                      key={i}
            ...
            <div className="mb-8">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <button
                    onClick={() =>
                      setSlideIndexSpaces(
                        Math.min(
                          Math.ceil(spacesData.length / 3) - 1,
                          slideIndexSpaces + 1,
                        ),
                      )
                    }
                    className="text-gray-400 hover:text-white text-lg px-2 py-1 rounded bg-transparent disabled:opacity-30"
                    disabled={
                      slideIndexSpaces >= Math.ceil(spacesData.length / 3) - 1
                    }
                  >
                    ›
                  </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {spacesData
                  .slice(slideIndexSpaces * 3, (slideIndexSpaces + 1) * 3)
                  .map((space, i) => (
                    <div
                      key={i}
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="bg-[#1E242E] h-32 rounded-lg hover:bg-[#242B38] transition"
                  ></div>
                ))}
              </div>
            </div>
