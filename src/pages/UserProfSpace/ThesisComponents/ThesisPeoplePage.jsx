      ...
      <div className="flex-1 flex flex-col w-full">
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {/* ADMIN */}
            <div>
              <h2 className="text-xl font-semibold mb-4">Lead Researcher</h2>
            ...
            <div>
              ...
              <div className="border-t border-gray-700 pt-4 space-y-4">
                {[
                  ...
                  {
                    name: "Zeldrick Delos Santos",
                    img: "/src/assets/SpacePeoplePage/zj.jpg",
                  },
                ].map((member, index) => (
...
export default ThesisPeoplePage;
