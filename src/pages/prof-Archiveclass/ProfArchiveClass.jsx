    ...
    <div className="flex min-h-screen font-sans" style={{ backgroundColor: currentColors.background, color: currentColors.text }}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-4 md:p-8 overflow-y-auto">
          ...
          {/* Welcome Section */}
          <div className="rounded-xl p-6 mb-10 border" style={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {archivedClasses.length > 0 ? (
                filteredClasses?.length > 0 ? (
                  filteredClasses.map((space) => (
                    ...
                    >
                      <div className="cursor-pointer">
                        <div className="relative h-40 overflow-hidden" style={{ backgroundColor: isDarkMode ? '#1f2937' : '#6b7280' }}>
                          <SpaceCover
                        ...
                        <div className="p-4">
                          <h3 className="font-semibold text-sm" style={{ color: currentColors.text }}>
                            {space.space_name}
                          </h3>
                      ...
                      <div className="absolute top-2 right-2 menu-container">
                        ...
                        {showMenu === space.space_id && (
                          <div className="absolute top-8 right-0 rounded-lg shadow-lg z-10 min-w-[160px]" style={{
                            backgroundColor: currentColors.surface,
                            borderColor: currentColors.border
                          }}>
                            <button
                              ...
                              style={{
                                ...
                                borderColor: isDarkMode ? '#3B4457' : currentColors.border
                              }}
                              onMouseEnter={(e) => {
                                e.currentTarget.style.backgroundColor = '#3B4457';
                              }}
                              onMouseLeave={(e) => {
                  ...
                  <div className="col-span-full p-4 rounded-lg border text-center" style={{
                    backgroundColor: currentColors.surface,
                    borderColor: currentColors.border,
                ...
                <div className="col-span-full flex flex-col items-center py-16">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style={{
                    ...
                    <Archive size={32} style={{ color: currentColors.textSecondary }} />
                  </div>
                  <h3 className="text-lg font-medium mb-2" style={{ color: currentColors.text }}>
                    No archived classes yet
                  </h3>
                  <p className="max-w-md text-center" style={{ color: currentColors.textSecondary }}>
          ...
          {showRestoreConfirm && (
            <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center px-4">
              <div className="rounded-xl p-6 max-w-sm w-full border" style={{
                backgroundColor: currentColors.surface,
                borderColor: currentColors.border
              }}>
                <h3 className="text-lg font-semibold mb-3" style={{ color: currentColors.text }}>Restore Space</h3>
                <p className="text-sm mb-6" style={{ color: currentColors.textSecondary }}>
          ...
          {showDeleteConfirm && (
            <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center px-4">
              <div className="rounded-xl p-6 max-w-sm w-full border" style={{
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: '#ef4444' }}>
                  Delete Permanently
                </h3>
                <p className="text-sm mb-6" style={{ color: currentColors.textSecondary }}>
