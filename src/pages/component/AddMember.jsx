...
const AddMember = ({ 
  ...
  const defaultStyles = {
    popupOverlay: "fixed inset-0 bg-black/60 flex items-center justify-center z-50",
    popupContainer: "bg-gradient-to-br from-[#2A2F3A] to-[#1E222A] rounded-2xl w-[420px] max-w-[90vw] p-6 shadow-2xl border border-gray-700",
    header: "flex items-center justify-between mb-6",
    iconContainer: "w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center",
    ...
    emailInput: "flex-1 bg-[#1E222A] border rounded-lg px-3 py-2 text-white text-sm outline-none transition-colors",
    ...
    sendButton: "px-4 py-2 rounded-lg transition-colors text-sm font-medium",
    linkContainer: "bg-gray-800/50 border border-gray-600 rounded-lg p-3",
    linkText: "text-xs text-gray-300 truncate flex-1 mr-2",
    copyButton: "text-sm px-3 py-1.5 rounded-lg transition-all transform hover:scale-105",
    infoSection: "bg-gray-800/30 border border-gray-700 rounded-lg p-4",
    infoContent: "flex items-start gap-3",
    infoIconContainer: "w-8 h-8 bg-blue-600/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5",
