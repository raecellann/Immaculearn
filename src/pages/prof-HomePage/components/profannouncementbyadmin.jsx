                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    {!viewedAnnouncements.has(announcement.announce_id) && (
                      <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: isDarkMode ? "#3B82F6" : "#2563EB" }}></div>
                    )}
                    <p
              ...
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-3 h-3 rounded-full flex-shrink-0" style={{ backgroundColor: isDarkMode ? "#3B82F6" : "#2563EB" }}></div>
                    <h2
