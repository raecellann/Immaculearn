      ...
      default:
        return (
          <div className="p-3 rounded-lg border" style={{
            ...
            <p style={{ color: currentColors.text }}>
              <strong>Answer:</strong> {question.answers[0]?.answer_text || 'No answer provided'}
            </p>
        ...
        {questions.map((question, index) => (
          <div key={question.id} className="p-6 rounded-lg border" style={{
            ...
            <div className="mb-4">
              ...
              <p className="text-lg leading-relaxed" style={{ color: currentColors.text }}>
                {question.question}
              </p>
            </div>
      ...
      <div className="mt-8 p-4 rounded-lg border" style={{
        ...
        <div className="flex justify-between items-center">
          <p style={{ color: currentColors.textSecondary }}>
            This is a preview of the quiz. Students will see this interface when taking the quiz.
          </p>
          <button 
