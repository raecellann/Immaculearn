            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  />
                  <div
                    className="flex gap-4 px-4 py-2 justify-center"
                  ...
                  >
                    ...
                    <button
                      ...
                      title={
                        selectedFile
                          ? selectedFile.name
                          : "Upload file (DOCS, PDF, PPT, EXCEL - up to 10MB)"
                      }
                    >
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="flex flex-col items-center gap-2 w-full">
                          <input
                            ...
                            onChange={(e) =>
                              updateQuestionQuantity(type.id, e.target.value)
                            }
                          ...
                          <button
                            ...
                            style={{
                              ...
                              cursor: !questionQuantities[type.id]
                                ? "not-allowed"
                                : "pointer",
                            }}
                            onMouseEnter={(e) =>
            ...
            {questions.length > 0 ? (
              <div className="space-y-6">
                ...
                {questions.map((question, index) => {
                  const isFirstOfItsType =
                    index === 0 || questions[index - 1]?.type !== question.type;
                  const questionsOfType = questions.filter(
                  ...
                  return (
                    ...
                    >
                      ...
                      {question.type === "reflection_essay" && (
                        <div className="mb-4">
                          <label className="block text-sm font-medium mb-2">
                            Sample Answer / Key Points (Optional):
                          </label>
                          <textarea
                            value={question.correctAnswer || ""}
                            onChange={(e) =>
                                ...
                                >
                                  ...
                                  {question.scoringCriteria.length > 1 && (
                                    <button
                                      ...
                                      onClick={() => {
                                        const newCriteria =
                                          question.scoringCriteria.filter(
                                            (_, i) => i !== index,
                                          );
                                        updateQuestion(
                                          question.id,
              ...
              <div className="text-center py-12 text-gray-500">
                ...
                <p>
                  No questions added yet. Select a question type above to get
                  started.
                </p>
              </div>
            )}
          ...
          <div className="bg-[rgb(30_36_46_/var(--tw-bg-opacity,1))] rounded-xl p-6 max-w-md w-full mx-4 border border-[#2F3440]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">
                  Delete All {deleteModal.questionLabel} Questions
                </h3>
                <p className="text-sm text-gray-400">
                  Are you sure you want to delete all{" "}
                  {deleteModal.questionCount}{" "}
                  {deleteModal.questionLabel.toLowerCase()} question
                  {deleteModal.questionCount > 1 ? "s" : ""}?
                </p>
              </div>
            </div>
            ...
            <div className="bg-red-900/20 border border-red-600/50 rounded-lg p-3 mb-6">
              <p className="text-sm text-red-300">
                ...
                questions of this type will be permanently removed from your
                form.
              </p>
            </div>
