                            ...
                            >
                              ...
                              {space.space_day && (
                                <>
                                  ...
                                  <span>
                                    {space.space_day}{" "}
                                    {formatTime(space.space_time_start)}-
                                    {formatTime(space.space_time_end)}
                                  </span>
                                </>
                              )}
                            </div>
              ...
              <div className="text-center py-12">
                ...
                >
                  ...
                  <p
                    ...
                    className="mb-6"
                  >
                    You haven't created or joined any spaces yet. Create your
                    first space to get started!
                  </p>
                  <button
                    onClick={() =>
                      user?.role === "professor"
                        ? navigate("/prof/space/create")
